...
embed.setFooter(message.author.tag + " | made by Bird YT", message.author.displayAvatarURL({ dynamic: true }));
embed.setTimestamp()
...
embed2.setFooter(message.guild.name + " | made by Bird YT", message.guild.iconURL());
